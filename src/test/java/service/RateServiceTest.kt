...
class RateServiceTest {
    ...
    @Test
    fun testAddRate() {
        val result = rateService.addRate(rate1.vehicleType, rate1.kmPrice, rate1.vignetteType)
    ...
    @Test
    fun testUpdateRate() {
        val result = rateService.updateRate(rate1.id, VehicleType.MOTOR, 15.0, VignetteType.TEN_DAYS)
